...
import { TransferListDemo } from './transfer-list-demo';

@Component({
  selector: 'app-transfer-list-demo-container',
  imports: [DemoContainer, TransferListDemo],
  template: `
    <app-demo-container title="Transfer" [code]="code">
      <app-transfer-list-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
