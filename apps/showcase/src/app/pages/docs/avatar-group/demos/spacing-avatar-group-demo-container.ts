...
import { SpacingAvatarGroupDemo } from './spacing-avatar-group-demo';

@Component({
  selector: 'app-spacing-avatar-group-demo-container',
  imports: [DemoContainer, SpacingAvatarGroupDemo],
  template: `
    <app-demo-container
