...
@Component({
  ...
  template: `
    <app-demo-container title="Hover" [code]="code">
...
@Component({
  ...
  imports: [ScHoverCard, ScHoverCardContent, ScHoverCardTrigger],
  template: \`
    <div class="flex flex-wrap items-center gap-8">
      ...
      <div sc-hover-card side="top" align="start">
        <span
          sc-hover-card-trigger
