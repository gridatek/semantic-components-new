...
import { ValidationFormDemo } from './validation-form-demo';

@Component({
  selector: 'app-validation-form-demo-container',
  imports: [DemoContainer, ValidationFormDemo],
  template: `
    <app-demo-container title="Validation States" [code]="code">
      <app-validation-form-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ValidationFormDemoContainer {
