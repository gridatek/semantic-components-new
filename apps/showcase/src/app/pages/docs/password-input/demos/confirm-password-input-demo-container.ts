...
import { ConfirmPasswordInputDemo } from './confirm-password-input-demo';

@Component({
  selector: 'app-confirm-password-input-demo-container',
  imports: [DemoContainer, ConfirmPasswordInputDemo],
  template: `
    <app-demo-container title="Password Confirmation" [code]="code">
      <app-confirm-password-input-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ConfirmPasswordInputDemoContainer {
