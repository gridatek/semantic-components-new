...
import { RegistrationFormPasswordInputDemo } from './registration-form-password-input-demo';

@Component({
  selector: 'app-registration-form-password-input-demo-container',
  imports: [DemoContainer, RegistrationFormPasswordInputDemo],
  template: `
    <app-demo-container title="Registration Form" [code]="code">
      <app-registration-form-password-input-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class RegistrationFormPasswordInputDemoContainer {
