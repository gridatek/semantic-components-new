...
import { LoginFormPasswordInputDemo } from './login-form-password-input-demo';

@Component({
  selector: 'app-login-form-password-input-demo-container',
  imports: [DemoContainer, LoginFormPasswordInputDemo],
  template: `
    <app-demo-container title="Login Form" [code]="code">
      <app-login-form-password-input-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class LoginFormPasswordInputDemoContainer {
