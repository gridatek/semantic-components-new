...
import { SimpleDataTableDemo } from './simple-data-table-demo';

@Component({
  selector: 'app-simple-data-table-demo-container',
  imports: [DemoContainer, SimpleDataTableDemo],
  template: `
    <app-demo-container title="Simple" [code]="code">
      <app-simple-data-table-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SimpleDataTableDemoContainer {
