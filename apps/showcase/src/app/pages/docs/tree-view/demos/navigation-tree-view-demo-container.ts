...
import { NavigationTreeViewDemo } from './navigation-tree-view-demo';

@Component({
  selector: 'app-navigation-tree-view-demo-container',
  imports: [DemoContainer, NavigationTreeViewDemo],
  template: `
    <app-demo-container
      title="Navigation"
      demoUrl="/demos/tree-view/navigation-tree-view-demo"
      [code]="code"
    >
      <app-navigation-tree-view-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NavigationTreeViewDemoContainer {
