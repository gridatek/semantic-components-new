...
```typescript
import { ScAccordion, ScAccordionItem, ScAccordionHeader, ScAccordionTrigger, ScAccordionPanel, ScAccordionContent, ScAccordionTriggerIcon } from '@semantic-components/ui';
```
